                                    ...
                                    <div class="container flex-wrap justify-content-right">
                                        <div class="card ">
                                            ...
                                            <div class="card-bottom pt-1 px-2 mb-2">
                                                <div class="d-flex flex-row justify-content-between text-align-center">
                                                    {/* <div class="d-flex flex-column"><span>Balance amount</span><p>&euro; <span class="text-dark">{addedaccount.balance}</span></p>
                                                    
                                                    </div>
                                                    <button class="btn btn-primary btn-outline-light btn-md"><i class="fas fa-arrow-right text-dark"></i>Get Balance</button> */}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row row-cols-2 row-cols-md-2 g-4 m-3" >
                            ...
                            <div class="col">
                                <div class="card shadow-lg p-3 mb-5 bg-body rounded">
                                    <a href='#'><img class="img-responsive" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPNTCeW0JjFCkSiWnMS1lWQcitVbf_sscAqw&usqp=CAU" class="card-img-top" alt="..." /></a>
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card shadow-lg p-3 mb-5 bg-body rounded">
                                    <a href='#'><img class="img-responsive"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEJWFsGGzmsnIF6ZxmuC_Z9F9pd_qHtK4PfA&usqp=CAU" class="card-img-top" alt="..." /></a>
                                    <div class="card-body">
